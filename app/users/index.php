                      ...
                      <div class="data-list shadow-sm bg-primary text-white app-sub-heading">
                        <p class="flex-s-b">
                          <span class="w-pr-3 text-left text-white">Sno</span>
                           <span class="w-pr-5 text-left text-white">EMPCode</span>
                          <span class="w-pr-18 text-left text-white">MemberName</span>
                          <span class="w-pr-12 text-left text-white">Desgination</span>
                          <span class="w-pr-7 text-left text-white">UserType</span>
                        ...
                        <div class="col-md-12">
                          <div class="p-1 mb-1 shadow-sm rounded-2 bg-white data-list">
                            <p class="mb-0 flex-s-b">
                              ...
                              <span class="w-pr-5 text-left text-black"><?php echo EMP_CODE;?>-<?php echo $Customers->UserEmpJoinedId; ?></span>
